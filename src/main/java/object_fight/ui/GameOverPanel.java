...
public class GameOverPanel extends javax.swing.JPanel {
    ...
    /**
     * Método para recibir el score antes de mostrar el panel de game over
    ...
    private void initComponents() {
        ...
        jPanelGameOver.setOpaque(false);
        jPanelGameOver.setPreferredSize(new java.awt.Dimension(150, 150));
        jPanelGameOver.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 0, 20));

        jLabelGameOver.setFont(new java.awt.Font("Berlin Sans FB Demi", 3, 60)); // NOI18N
        ...
        jPanelTitulo.add(jPanelGameOver);

        jPanelScore.setOpaque(false);
        jPanelScore.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 0, 20));
        ...
        jPanelIniciarPartida.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 0, 20));
        ...
        jPanelSalir.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 0, 20));
